...
public class TapSettingsModel implements GenericToroModel {
	...
	public static void main(String[] args) {
		...
		System.out.println("lDeviceWidth " + Double.toString(tsm.lDeviceWidth) + " " + 1284 / 458 + " lDeviceWidth/lImage " + tsm.lCalculatedPXWidth + " multiply image back in " + tsm.lCalculatedPXWidth * tsm.lImageNumberOfPXWidth);
		System.out.println("PX Width: " + tsm.lCalculatedPXWidth + " PX Height: " + tsm.lCalculatedPXHeight);
		System.out.println("Device Width: " + (tsm.lCalculatedPXWidth*tsm.lImageNumberOfPXWidth) + " Device Height: " + tsm.lCalculatedPXHeight*tsm.lImageNumberOfPXHeight);
